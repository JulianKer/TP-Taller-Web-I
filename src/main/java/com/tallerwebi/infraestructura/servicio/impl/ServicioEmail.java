...
public class ServicioEmail {
    ...
    public String formarMensajeParaIntercambio(Usuario usuario, Transaccion nuevaTransaccion) {
        return "<!DOCTYPE html>\n" +
                "<html lang=\"es\">\n" +
                "<head>\n" +
                "    <meta charset=\"UTF-8\">\n" +
                ...
                "            <li style='color: #FFF'><strong style='color: #FFF'>Criptomoneda entregada:</strong> " + nuevaTransaccion.getCriptomoneda().getNombreConMayus() + " (" + nuevaTransaccion.getCriptomoneda().getSimbolo() + ")</li>\n" +
                "            <li style='color: #FFF'><strong style='color: #FFF'>Cantidad:</strong> " + nuevaTransaccion.getCantidadDeCripto() + "</li>\n" +
                "            <li style='color: #FFF'><strong style='color: #FFF'>Precio unitario:</strong> " + nuevaTransaccion.getPrecioAlQueSehizo() + " USD</li>\n" +
                "            <li style='color: #FFF'><strong style='color: #FFF'>Criptomoneda obtenida:</strong> " + nuevaTransaccion.getCriptomoneda2().getNombreConMayus() + " (" + nuevaTransaccion.getCriptomoneda().getSimbolo() + ")</li>\n" +
                "            <li style='color: #FFF'><strong style='color: #FFF'>Cantidad:</strong> " + nuevaTransaccion.getCantidadDeCripto2() + "</li>\n" +
                "            <li style='color: #FFF'><strong style='color: #FFF'>Precio unitario:</strong> " + nuevaTransaccion.getPrecioAlQueSehizo2() + " USD</li>\n" +
                "            <li style='color: #FFF'><strong style='color: #FFF'>Monto total:</strong> " + nuevaTransaccion.getMontoTotal() + " USD</li>\n" +
                "            <li style='color: #FFF'><strong style='color: #FFF'>N° Transacción:</strong> " + nuevaTransaccion.getId() + "</li>\n" +
                "        </ul>\n" +
                "        <div class=\"footer\">\n" +
